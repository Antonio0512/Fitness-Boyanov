...
class AttendanceAddForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'login': forms.TimeInput(attrs={'class': 'form-control mt-2', 'required': True, 'type': 'time'}),
            'logout': forms.TimeInput(attrs={'class': 'form-control mt-2', 'required': True, 'type': 'time'}),
